...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(1.2056, 36.7796), // Ruaka

        // How you would like to style the map. 
        // Created style in Snazzy Maps.
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(1.2056, 36.7796),
        map: map,
